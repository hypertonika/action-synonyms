...
Материалы для планирования урока, самостоятельной работы, оценки результатов и корректного использования ИИ-функции.
...
<b>Дополнительный учет активности</b>
Критерии можно адаптировать под вашу систему оценивания. Рекомендуется вести лист учета активности в Excel или Google Sheets и фиксировать:
- количество пройденных квизов;
- средний процент правильных ответов;
- участие в дополнительных заданиях: мини-диалоги, эссе, презентации.""",
...
Create a presentation using 10 synonyms from the Mining topic.""",
    "ai": """<b>Учебные материалы и ИИ-функция</b>

<b>Важно</b>
Весь учебный материал находится внутри бота: слова, синонимы, тесты, flashcards, квизы, тексты для Reading и задания Listening. Печатная версия используется только как сопровождение к работе в боте.

<b>Транскрипция</b>
В боте транскрипция не добавлена намеренно: главная задача - научить студентов подбирать синонимы, понимать значение слова и писать грамотно. Если нужно проверить произношение, используйте онлайн-словарь, например Cambridge Dictionary.

<b>ИИ-функция</b>
Если слова нет в базе, бот может сгенерировать краткое объяснение, синонимы и пример употребления. Это полезно для редких, новых или профессиональных терминов.

<b>Рекомендации преподавателю</b>
- давайте задания прямо в боте;
- просите студентов проходить тесты и отправлять скриншоты результатов""",
...
def teacher_menu_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🤖 Учебные материалы и ИИ", callback_data="teacher:ai")],
